...
return{
    ...
    modes={
        ...
        ['secret_grade']=   {"裏GM",                  "",              "ガイドに従ってジグザグに穴を作り出せ!"},
        ['dig_10l']=        {"掘り",                  "10L",           "10ライン下穴を掘れ!"},
        ['dig_40l']=        {"掘り",                  "40L",           "40ライン下穴を掘れ!"},
        ['dig_100l']=       {"掘り",                  "100L",          "100ライン下穴を掘れ!"},
        ['dig_400l']=       {"掘り",                  "400L",          "400ライン下穴を掘れ!"},
        ['dig_eff_10l']=    {"堀り",               "EFFICIENCY 10L", "最小のミノ数で10ライン下穴を掘れ!"},
        ['dig_eff_40l']=    {"堀り",               "EFFICIENCY 40L", "最小のミノ数で40ライン下穴を掘れ!"},
        ['dig_eff_100l']=   {"堀り",               "EFFICIENCY 100L","最小のミノ数で100ライン下穴を掘れ!"},
        ['dig_eff_400l']=   {"堀り",               "EFFICIENCY 400L","最小のミノ数で400ライン下穴を掘れ!"},
